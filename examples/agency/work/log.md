...
|------------------|-------|---------|------|
| 2026-06-24 09:02 | 📋 | acme | morning briefing — 3 in Doing, board reviewed; focus = ship the onboarding flow |
| 2026-06-24 10:18 | 💻 | startupxyz | onboarding flow — wired the email-verification step, 6 tests green |
| 2026-06-24 11:47 | 🐛 | bigcorp | payment webhooks failing in prod → opened bigcorp-api-payment-retry (incident, P1) |
...
| Timestamp        | Glyph | Context | What |
|------------------|-------|---------|------|
| 2026-06-23 15:40 | 🔧 | platform | bumped CI runners and pinned deps (platform-maintenance stream) |
| 2026-06-23 16:55 | 📋 | startupxyz | closed dark-mode-toggle → done; persisted via localStorage |
