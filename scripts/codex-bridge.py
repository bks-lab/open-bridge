...
"""Bridge context and per-turn logging checks for Codex; no client hook implied."""
...
def doctor(root):
    ...
    for error in errors:
        print('FAIL: ' + error)
    if not errors:
        print('PASS: Codex skill entry and available repository knowledge routing')
...
def main():
    ...
    state_dir = root / '.bridge/codex-sessions'
